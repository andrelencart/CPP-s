...
int main(void) {
	...
	std::cout << "---- Creating invalid form " << std::endl;
	form4 = someRandomIntern.makeForm("unknown form", "target");

	// std::cout << "---- Testing created form1 " << std::endl;
	// if (form1) {
	...
	// std::cout << "---- Testing created form2 " << std::endl;
	// if (form2) {
	...
	// std::cout << "---- Testing created form3 " << std::endl;
	// if (form3) {
